...
abstract class CategoryRepository {
  ...
  static final List<ExpenseCategory> defaultCategories = [
    ExpenseCategory(
        id: 'food_dining', name: 'Food & Dining', icon: AppIcons.foodDining),
    ExpenseCategory(
        id: 'transportation',
        name: 'Transportation',
    ...
    ExpenseCategory(
        ...
        icon: AppIcons.billsUtilities),
    ExpenseCategory(id: 'health', name: 'Health', icon: AppIcons.health),
    ExpenseCategory(id: 'travel', name: 'Travel', icon: AppIcons.travel),
    ExpenseCategory(
        id: 'education', name: 'Education', icon: AppIcons.education),
    ExpenseCategory(
        id: 'subscription', name: 'Subscription', icon: AppIcons.subscription),
  ...
  Future<void> updateCategory(
      ExpenseCategory oldCategory, ExpenseCategory newCategory);
